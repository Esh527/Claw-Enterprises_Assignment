...
const Login = () => {
  ...
  return (
    <div className="login-cont">
      ...
      <p className='register-route mb-5'>
      ...
      <p className='mt-5'>Note: Please wait for some time after clicking login, <span className='text-warning font-weight-bold'>Backend is slow/ Try again</span></p>
    </div>
  );
}
